...
const ParticleBackground = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full -z-10 bg-primary">
      ...
      <div className="absolute top-[40%] right-[20%] w-[30%] h-[30%] rounded-full bg-cyan-600/20 blur-[100px] animate-blob" style={{ animationDelay: '4s' }}></div>
